...
#
# This file is part of yang-sid, previsouly part of Yangson.
#
# yang-sid is free software: you can redistribute it and/or modify it under the
# terms of the GNU Lesser General Public License as published by the Free
# Software Foundation, either version 3 of the License, or (at your option) any
# later version.
#
# yang-sid is distributed in the hope that it will be useful, but WITHOUT ANY
# WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR
# A PARTICULAR PURPOSE.  See the GNU Lesser General Public License for more
# details.
#
# You should have received a copy of the GNU Lesser General Public License
# along with yang-sid.  If not, see <http://www.gnu.org/licenses/>.
...
from yang_sid import DataModel
...
def main(infile: Optional[str] = None, pickled: bool = False,
    ...
    if infile is None:
        ...
        parser.add_argument(
            ...
            help="show the yang-sid library version number and exit",
            version=f"%(prog)s {importlib.metadata.version('yang-sid')}")
        parser.add_argument(
        ...
        parser.add_argument(
            "--sid",action="store_true",
            help="")
        parser.add_argument(
            "--sid-cost", action="store_true",
            help="")
        parser.add_argument(
            "--sid-path",
            help="")
    ...
    if tree:
        ...
        print(dm.ascii_tree(no_types, sid=sid, sid_cost=sid_cost))
        return 0
    if digest:
